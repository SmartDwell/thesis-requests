...
namespace Thesis.Requests.Server.Migrations
{
    ...
    [Migration("20230610181842_RefactoringIncidentPoint")]
    partial class RefactoringIncidentPoint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Thesis.Requests.Model.Request", b =>
                {
                    ...
                    b.Property<string>("IncidentPointFullName")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<Guid>("IncidentPointId")
                        .HasColumnType("uuid");
